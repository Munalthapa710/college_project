...
- **Request Timeout & Rerouting:** If a requested driver doesn't respond within 2 seconds, the system automatically cancels the request and dispatches the next nearest driver.
